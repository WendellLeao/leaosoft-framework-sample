        ...
        public struct LandMapActions
        {
            ...
            public void SetCallbacks(ILandMapActions instance)
            {
                if (m_Wrapper.m_LandMapActionsCallbackInterface != null)
                {
                    ...
                    @Shoot.started -= m_Wrapper.m_LandMapActionsCallbackInterface.OnShoot;
                    @Shoot.performed -= m_Wrapper.m_LandMapActionsCallbackInterface.OnShoot;
                    @Shoot.canceled -= m_Wrapper.m_LandMapActionsCallbackInterface.OnShoot;
